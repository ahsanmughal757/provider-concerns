            ...
            <div className="col-sm-6 col-lg-3">
              <div className="service-item bg rounded-4">
                <div className="service-front">
                  ...
                  <Link href="/specialities/pain-management">
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="service-item bg rounded-4">
                <div className="service-front">
                  ...
                  <Link href="/specialities/internal-medicine">
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="service-item bg rounded-4">
                <div className="service-front">
                  ...
                  <Link href="/specialities/gynecology">
                    <h3>Gynecology</h3>
                  </Link>
                </div>
              </div>
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="service-item bg rounded-4">
                <div className="service-front">
                  ...
                  <Link href="/specialities/immunology">
                    <h3>Immunology</h3>
                  </Link>
                </div>
              </div>
                ...
                <div className="service-front">
                  <i className="icofont-2xl">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      xmlnsXlink="http://www.w3.org/1999/xlink"
                      viewBox="-5.14 -5.14 524.61 524.61"
                      xmlSpace="preserve"
                      stroke="#0088cc"
                      strokeWidth="5.14327"
                    >
                      ...
                      <g id="SVGRepo_iconCarrier">
                        ...
                        <g>
                          ...
                          <g>
                            {" "}
                            <path d="M359.564,285.091c-5.818-5.818-12.8-5.818-17.455-2.327c-4.655,3.491-5.818,11.636-1.164,16.291 c12.8,16.291,20.945,34.909,20.945,51.2c0,6.982,4.655,11.636,11.636,11.636s11.636-4.655,11.636-11.636 C385.164,329.309,375.855,304.873,359.564,285.091z"></path>{" "}
                          </g>{" "}
                        </g>{" "}
                        <g>
                          {" "}
                          <g>
                            {" "}
                            <path d="M422.4,281.6l-34.909-11.636c-5.818-2.327-12.8,1.164-13.964,6.982c-2.327,5.818,1.164,12.8,6.982,15.127l34.909,11.636 c1.164,0,2.327,1.164,3.491,1.164c4.655,0,9.309-3.491,10.473-8.145C431.709,290.909,428.218,283.927,422.4,281.6z"></path>{" "}
                          </g>{" "}
                        </g>{" "}
                        <g>
                          {" "}
                          <g>
                            {" "}
                            <path d="M415.418,202.473c-4.655-4.655-11.636-4.655-16.291,0l-34.909,34.909c-4.655,4.655-4.655,11.636,0,16.291 c2.327,2.327,5.818,3.491,8.145,3.491s5.818-1.164,8.145-3.491l34.909-34.909C420.073,214.109,420.073,207.127,415.418,202.473z"></path>{" "}
                          </g>{" "}
                        </g>{" "}
                        <g>
                          {" "}
                          <g>
                            {" "}
                            <path d="M171.055,282.764c-4.655-3.491-12.8-3.491-16.291,1.164C137.309,304.873,128,329.309,128,350.255 c0,6.982,4.655,11.636,11.636,11.636s11.636-4.655,11.636-11.636c0-16.291,8.146-34.909,20.945-51.2 C175.709,294.4,175.709,286.255,171.055,282.764z"></path>{" "}
                          </g>{" "}
                        </g>{" "}
                        <g>
                          {" "}
                          <g>
                            {" "}
                            <path d="M138.473,275.782c-2.327-5.818-8.145-9.309-15.127-6.982l-34.909,11.636c-4.655,2.327-8.145,9.309-5.818,15.127 c1.164,4.655,5.818,8.145,10.473,8.145c1.164,0,2.327,0,3.491-1.164l34.909-11.636C137.309,288.582,140.8,282.764,138.473,275.782 z"></path>{" "}
                          </g>{" "}
                        </g>{" "}
                        <g>
                          {" "}
                          <g>
                            {" "}
                            <path d="M147.782,237.382l-34.909-34.909c-4.655-4.655-11.636-4.655-16.291,0s-4.655,11.636,0,16.291l34.909,34.909 c2.327,2.327,4.655,3.491,8.145,3.491s5.818-1.164,8.145-3.491C152.436,249.018,152.436,242.036,147.782,237.382z"></path>{" "}
                          </g>{" "}
                        </g>{" "}
                      </g>
                    </svg>
                  </i>
                  <Link href="/specialities/pulmonology">
                    <h3>Pulmonology</h3>
                  </Link>
                </div>
              </div>
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="service-item bg rounded-4">
                <div className="service-front">
                  ...
                  <Link href="/specialities/traumatology">
                    <h3>Traumatology</h3>
                  </Link>
                </div>
              </div>
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="service-item bg rounded-4">
                <div className="service-front">
                  ...
                  <Link href="/specialities/physical-therapy">
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="service-item bg rounded-4">
                <div className="service-front">
                  ...
                  <Link href="/specialities/pediatric">
                    <h3>Pediatric</h3>
                  </Link>
                </div>
              </div>
