            ...
            <div className="col-sm-12 col-md-12 col-lg-4">
              ...
              >
                <div className="service-front">
                  ...
                  <h3 style={{cursor: 'default'}}>Eligibility Verification</h3>
                  <p>
              ...
              >
                <div className="service-front">
                  ...
                  <h3 style={{cursor: 'default'}}>Compliance With Regulations</h3>
                  <p>
            ...
            <div className="col-sm-12 col-md-12 col-lg-4">
              ...
              >
                <div className="service-front">
                  ...
                  <h3 style={{cursor: 'default'}}>Patient Billing and Invoicing</h3>
                  <p>
              ...
              >
                <div className="service-front">
                  ...
                  <h3 style={{cursor: 'default'}}>Denial Management</h3>
                  <p>
              ...
              >
                <div className="service-front">
                  ...
                  <h3 style={{cursor: 'default'}}>Coding Services</h3>
                  <p>
